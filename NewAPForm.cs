...
namespace Acct
{
    public partial class NewAPForm : Form
    {
        ...
        public Panel GetNewAcctPayablePanel()
        {
            return this.newacctpayablepanel;
        }
        ...
        "Provider=Microsoft.Jet.OLEDB.4.0;"
                ...
                com.Connection = con;
                com.CommandText = "INSERT INTO AcctAP(accountid, company, firstName, lastName, [date], [time], amount, invoiceNo, description)VALUES(" + this.accountid + ", '"+companytb.Text.Replace("'","''")+"','" + firstNametb.Text.Replace("'","''") + "','" + lastnametb.Text.Replace("'","''") + "','" + datetb.Text + "','" + timetb.Text + "'," + amounttb.Text + ",'" + invoiceNotb.Text.Replace("'","''") + "','" + description.Text.Replace("'","''") + "')";
                com.ExecuteNonQuery();
